...
export default function() {
  ...
  let res = http.get("https://bpcalculator20221210142544.azurewebsites.net/", {"responseType": "text"});
  ...
  res = res.submitForm({
    fields: { BP_Diastolic: getRandomInt(40,100).toString(), BP_Systolic: getRandomInt(70, 190).toString()}
  });
